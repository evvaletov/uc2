...
4. **Modern Compression Backends** — rANS entropy coder done (<5%
   overhead vs Shannon).  Remaining: zstd-inspired dictionary
   compression, content-aware preprocessing, integration into
   archive format with new method IDs.
